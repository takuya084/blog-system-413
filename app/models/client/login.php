...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
	...
	if ($mail_address && $password) {
	    $client = getClient($mail_address, $password, $pdo);
	    if (!$client) {
...
<head>
  ...
  <link href="<?php echo CONTENTS_SERVER_URL ?>/assets/plugins/bootstrap/4.1.3/css/bootstrap.min.css"
    rel="stylesheet" />
    ...
    <div class="login login-with-news-feed">
      ...
      <div class="news-feed">
        <div class="news-image"
          style="background-image: url(<?php echo CONTENTS_SERVER_URL ?>/assets/img/login-bg/login-bg-11.jpg)"></div>
        ...
        <div class="login-content">
          <form method="POST" action="" class="margin-bottom-0">
            <div class="form-group m-b-15">
              <input id="mail_address" name="mail_address" type="text" class="form-control form-control-lg "
